...
$(document).ready(function(){
$('#selectors').mouseleave(function(){
  $('#play , #pause').fadeTo(500, 0.02);;
...
$(document).ready(function(){
    $('#donegalaudio, p40').mouseenter(function(){
        
          $(".loader-container").fadeIn(100).removeClass('hidden');
        $("#roller").css({left: '10vw',top: '83vh'});
        $("#tweedaudio , #glassaudio , #stoneaudio").fadeIn(50).removeClass('hidden');
  $("#audiotext").html("Introduction");
      
    

  });
    
    $('#donegalaudio, p40').mouseleave(function(){
        $('#donegalaudio').fadeIn(50).removeClass('hidden');
        $('.loader-container').fadeOut(50).addClass('hidden');
...
$(document).ready(function(){
    $('#tweedaudio, p41').mouseenter(function(){
       
          $(".loader-container").fadeIn(100).removeClass('hidden');
        $("#roller").css({left: '-33.5vw',top: '53vh'});
        $("#donegalaudio , #glassaudio , #stoneaudio").fadeIn(500).removeClass('hidden');
          $("#audiotext").html("Growth of Craft Industry");

      
    

  }); $('#tweedaudio, p41').mouseleave(function(){
...
$(document).ready(function(){
    $('#glassaudio, p42').mouseenter(function(){
        
          $(".loader-container").fadeIn(100).removeClass('hidden');
        $("#roller").css({left: '-29vw',top: '63vh'});
          $("#audiotext").html("Hello World");
        $("#donegalaudio , #tweedaudio , #stoneaudio").fadeIn(100).removeClass('hidden');
         $("#audiotext").html("Benefits of Social Media");
        
        

    

  });$('#glassaudio, p42').mouseleave(function(){
...
$(document).ready(function(){
    $('#stoneaudio, p43').mouseenter(function(){
       
        $(".loader-container").fadeIn(100).removeClass('hidden');
        
        $("#roller").css({left: '-23vw',top: '73.2vh'});
        $("#donegalaudio , #tweedaudio , #glassaudio").fadeIn(100).removeClass('hidden');
 $("#audiotext").html("Significance of Donegal");
      
    

  });$('p43, #stoneaudio').mouseleave(function(){
        $("#audiotext").html("");
        $('.loader-container').fadeOut(50).addClass('hidden');
...
$(document).ready(function(){
    $('#audio5').mouseenter(function(){
        ...
        $(".loader-container").fadeIn(100).removeClass('hidden');
        $("#audiotext").html("Benefits of Websites");
...
$(document).ready(function(){
    $('#audio6').mouseenter(function(){
        ...
        $(".loader-container").fadeIn(100).removeClass('hidden');
          $("#audiotext").html("Significance of Handmade");
...
$(document).ready(function(){
    var audio =  $("#1")[0];
$("#donegalaudio").mouseenter(function() {
		audio.play();
...
$(document).ready(function(){
    var audio =  $("#2")[0];
$("#tweedaudio").mouseenter(function() {
		audio.play();

    $("#tweedaudio").mouseleave(function() {
		audio.pause();
        audio.currentTime = 0;
...
$(document).ready(function(){
    var audio =  $("#3")[0];
$("#stoneaudio").mouseenter(function() {
		audio.play();

    $("#stoneaudio").mouseleave(function() {
		audio.pause();
        audio.currentTime = 0;
...
$(document).ready(function(){
    var audio =  $("#4")[0];
$("#glassaudio").mouseenter(function() {
		audio.play();

    $("#glassaudio").mouseleave(function() {
		audio.pause();
        audio.currentTime = 0;
...
$(document).ready(function(){
    $('#headshot2').mouseenter(function() {
        
        $('#gdesign').fadeIn(300).removeClass('hidden');
             $('p103').css("display", "block");
          $('#headshot2').css("z-index", "100");
         $('#headshot1, #tcraft, #pcraft').css("z-index", "-1");
         $('#headshot2').css("opacity", "1");
         $('#headshot1').css("z-index", "-1");
        $('#headshot3').css("opacity", "1");
        
         
          $('#headshot3').css("z-index", "-1");
        
        });
     $('#headshot2').mouseleave(function() {
         $('#gdesign').css('display','none');
            $('p103').css("display", "none");
          
         $('#headshot1, #headshot3').css("z-index", "1");
         $('#tcraft, #pcraft').css("z-index", "1");
...
$(document).ready(function(){
    $('#section5').mouseenter(function() {
           ...
           $('#headshot2, #headshot1, #headshot3').css({bottom: '50%'},  100);
...
$(document).ready(function(){
    $('#headshot1').mouseenter(function() {
         $('p102').css("display", "block");
        $('#hweaver').fadeIn(300).removeClass('hidden');
      
           $('#ecraft, #pcraft').css("z-index", "-1");
         $('#headshot1').css("z-index", "1");
         $('#headshot2').css("z-index", "-1");
         $('#headshot3').css("z-index", "-1");
       
        });
     $('#headshot1').mouseleave(function() {
          $('p102').css("display", "none");
         $('#hweaver').css('display','none'); 
           $('#ecraft, #pcraft').css("z-index", "1");
         
          $('#headshot2, #headshot3').css("z-index", "1");
         $('#headshot1').css("z-index", "1");
...
$(document).ready(function(){
    $('#headshot3').mouseenter(function() {
       $('p104').css("display", "block");
        $('#smason').fadeIn(150).removeClass('hidden');
          $('#tcraft, #ecraft').css("z-index", "-1");
         $('#headshot1').css("z-index", "-1");
         $('#headshot2').css("z-index", "-1");
         $('#headshot3').css("z-index", "100");
        
        });
     $('#headshot3').mouseleave(function() {
          $('p104').css("display", "none");
         $('#smason').css('display','none'); 
            $('#tcraft, #ecraft').css("z-index", "1");
          $('#headshot2, #headshot1').css("z-index", "1");
...
$(document).ready(function(){
    $('#groupicon').mouseenter(function() {
        
        $('#artisans').fadeIn(300).removeClass('hidden');
        
        
        });
     $('#groupicon').mouseleave(function() {
         $('#artisans').fadeOut(100).addClass('hidden');
...
$(document).ready(function(){
    $('#motiveicon').mouseenter(function() {
        
        $('#motivepage').fadeIn(300).removeClass('hidden');
        
        
        });
     $('#motiveicon').mouseleave(function() {
         $('#motivepage').fadeOut(100).addClass('hidden');
...
$(document).ready(function(){
    $('#councilicon').mouseenter(function() {
        
        $('#council').fadeIn(300).removeClass('hidden');
        
        
        });
     $('#councilicon').mouseleave(function() {
         $('#council').fadeOut(100).addClass('hidden');
  ...
  $(document).ready(function(){  
         $('#menubox').fadeIn(3000).removeClass('hidden');
     
      $('#mainmenu').addClass('animated slideInDown');
  ...
  $(document).ready(function(){  
      ...
      $('h13').fadeIn(200).removeClass('hidden');
      ...
      $('h13').fadeOut(200).addClass('hidden');
 ...
 $(document).ready(function(){  
      ...
      $('h11').fadeIn(200).removeClass('hidden');
      ...
      $('h11').fadeOut(200).addClass('hidden');
 ...
 $(document).ready(function(){  
      ...
      $('h12').fadeIn(200).removeClass('hidden');
   
      
        
      });
      
      $('#home3').mouseleave(function(){ 
      $('h12').fadeOut(200).addClass('hidden');
 ...
 $(document).ready(function(){  
      ...
      $('h14').fadeIn(200).removeClass('hidden');
   
      
        
      });
      
      $('#home4').mouseleave(function(){ 
      $('h14').fadeOut(200).addClass('hidden');
...
function newPopup3(url) {
 ...
 $(document).ready(function(){  
$("#introductionvid").bind("ended", function() {
   $("#introductionvid").fadeOut(800).addClass("hidden");
...
$("#skipme").click(function() {
   ...
   $("#introductionvid, #skipme, #unmute").fadeOut(200).addClass("hidden");
...
$(document).on('click', '#skip', function (e) {
    var video = $("#introductionvid").get(0);
...
$("#playintro").click(function() {
   $("#introductionvid, #skip").fadeIn(200).removeClass("hidden");
...
$(document).ready(function(){  
  $(".unmute").click( function (){
       $("#introductionvid").prop('muted', !$("#introductionvid").prop('muted'));
      $('.unmute').toggleClass('mute');
  		                    ...
  		                    function expandThis() {
     document.getElementById('photobox').innerHTML = '<img src="images/paul/paul9.jpg" id="photo8-x" /> ';
}
...
/*WE DID NOT WRITE THIS CODE. THIS IS FOR PLUG IN PURPOSES.  
...
/*end of Github Code. Most was unused.*/
